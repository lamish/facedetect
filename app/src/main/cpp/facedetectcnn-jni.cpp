...
Java_com_aistem_facedetection_Camera2BasicFragment_facedetect(JNIEnv *env,jobject /* this */,jlong matAddr)
{
     ...
     * 获取Face类以及其对于参数的签名
     */
    jclass faceClass = env->FindClass("com/aistem/facedetection/Face");//获取Face类
