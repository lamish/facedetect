...
//        }
    ...
    private fun setUpCameraOutputs(
        ...
        try {
            for (cameraId in manager.cameraIdList) {
                ...
                Log.e(TAG, "====3333cameraId====="+cameraId)
                ...
                Log.d(TAG, "5555====cameraId====="+this.cameraId)

                this.cameraId = cameraId
                Log.d(TAG, "2222====cameraId====="+this.cameraId)
                return
            }
    ...
    private fun openCamera(
        ...
        if (!checkedPermissions && !allPermissionsGranted()) {
            FragmentCompat.requestPermissions(this, requiredPermissions,
        ...
        try {
            ...
            Log.d(TAG, "cameraId222=="+cameraId)
        } catch (e: CameraAccessException) {
    ...
    private fun classifyFrame() {
        ...
        val bitmap = textureView!!.getBitmap(640, 640)

        val mat = MatOfRect()
        Utils.bitmapToMat(bitmap, mat)

        val facesArray = facedetect(mat.nativeObjAddr)
        Log.d(TAG, "face num =" + facesArray.size)
        drawView!!.resetDrawPoint()
        for (face in facesArray) {
            if(face.faceConfidence > 60) {
                drawView!!.setDrawPoint(face.faceRect,1f)
            }
        }
    ...
    external fun facedetect(matAddr: kotlin.Long): Array<Face>
